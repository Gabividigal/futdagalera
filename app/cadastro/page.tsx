        ...
        {showSuccessState ? (
          <div className="rounded-[28px] border border-red-800/60 bg-[#111214]/90 px-5 py-7 shadow-[0_30px_90px_rgba(0,0,0,0.65)] backdrop-blur-sm sm:px-7">
            <div className="mb-5 flex justify-center">
              <div className="flex h-16 w-16 items-center justify-center rounded-full border border-red-500/60 bg-red-500/10 text-2xl">
                ✉️
              </div>
            </div>

            <h1 className="mb-4 text-center text-3xl font-black uppercase tracking-[0.12em] text-white sm:text-4xl">
              Verifique seu e-mail
            </h1>

            <p className="text-center text-sm leading-6 text-slate-300">
              Enviamos um link de confirmação para <span className="font-bold text-red-200">{confirmationEmail}</span>.
            ...
            <button
              ...
              className="mt-6 w-full rounded-xl bg-gradient-to-r from-red-700 to-red-500 px-4 py-3 text-base font-black uppercase tracking-[0.12em] text-white shadow-lg shadow-red-900/30 transition duration-200 hover:-translate-y-0.5 hover:shadow-red-800/40 focus:outline-none focus:ring-2 focus:ring-red-500/40"
            >
              Ir para o login
            </button>
          </div>
